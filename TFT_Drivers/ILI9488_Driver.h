...
class ILI9488_Driver : public Driver, public CommandExecutor {
public:
    explicit ILI9488_Driver(const Configuration& cfg);
    ~ILI9488_Driver() override = default;
