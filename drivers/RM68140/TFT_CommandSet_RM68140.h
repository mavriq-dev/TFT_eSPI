#ifndef _TFT_COMMANDSET_RM68140_H_
#define _TFT_COMMANDSET_RM68140_H_

#include "../../TFT_Command.h"

namespace TFT_Runtime {

class TFT_CommandSet_RM68140 : public CommandSequenceFactory {
public:
    CommandSequence createInitSequence() override {
        CommandSequence seq("RM68140 Init");
        ...
        seq.addDataList({0x00, 0x1B});
        
        // Display Function Control
        seq.addCommand(0xB6, "Display Function Control");
        seq.addDataList({0x0A, 0xA2});
    ...
    CommandSequence createSleepSequence() override {
        CommandSequence seq("RM68140 Sleep");
    ...
    CommandSequence createWakeSequence() override {
        CommandSequence seq("RM68140 Wake");
        seq.addCommand(0x11, "Sleep Out");
        seq.addDelay(120);
        seq.addCommand(0x29, "Display On");
        seq.addDelay(20);
    ...
    CommandSequence createDisplayOnSequence() override {
        CommandSequence seq("RM68140 Display On");
        seq.addCommand(0x29, "Display On");
        seq.addDelay(20);
        seq.addEnd();
        return seq;
    ...
    CommandSequence createDisplayOffSequence() override {
        CommandSequence seq("RM68140 Display Off");
        seq.addCommand(0x28, "Display Off");
        seq.addDelay(20);
        seq.addEnd();
        return seq;
    ...
    CommandSequence createInvertOnSequence() override {
        CommandSequence seq("RM68140 Invert On");
    ...
    CommandSequence createInvertOffSequence() override {
        CommandSequence seq("RM68140 Invert Off");
        seq.addCommand(0x20, "Display Inversion OFF");
        seq.addEnd();
        return seq;
    }

    // Additional RM68140-specific sequences
    CommandSequence createSetRotationSequence(uint8_t rotation) {
        CommandSequence seq("RM68140 Set Rotation");
        uint8_t madctl = 0;
    ...
    CommandSequence createSetWindowSequence(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1) {
        CommandSequence seq("RM68140 Set Window");
    ...
    CommandSequence createSetVCOMSequence(uint8_t vcom1, uint8_t vcom2) {
        CommandSequence seq("RM68140 Set VCOM");
        seq.addCommand(0xC5, "VCOM Control");
    ...
    CommandSequence createSetFrameRateSequence(uint8_t divider, uint8_t rtni) {
        CommandSequence seq("RM68140 Set Frame Rate");
        seq.addCommand(0xB1, "Frame Rate Control");
        seq.addDataList({divider, rtni});  // Default: 0x00, 0x1B
        seq.addEnd();
        return seq;
    }

    CommandSequence createSetGammaSequence(bool positive, const std::vector<uint8_t>& gammaValues) {
        CommandSequence seq("RM68140 Set Gamma");
    ...
    CommandSequence createSetDisplayFunctionSequence(uint8_t ptg, uint8_t pt) {
        CommandSequence seq("RM68140 Set Display Function");
        seq.addCommand(0xB6, "Display Function Control");
        seq.addDataList({ptg, pt});  // Default: 0x0A, 0xA2
        seq.addEnd();
        return seq;
    }
};
...
#endif // _TFT_COMMANDSET_RM68140_H_
